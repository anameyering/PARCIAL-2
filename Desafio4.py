...
#Se for escolhido soma, o Pynthon soma n1 e n2 e mostra o resultado na tela (print)
if operação == "soma":
  print( n1 + n2)

#Se for escolhido subtração, o Pynthon subtrai n1 e n2 e mostra o resultado na tela (print)
elif operação == "subtração":
  print( n1 - n2)

#Se for escolhido multiplicação, o Pynthon multiplica n1 e n2 e mostra o resultado na tela (print)
elif operação == "multiplicação":
  print( n1 * n2)

#Se for escolhido divisão, o Pynthon divide n1 e n2 e mostra o resultado na tela (print)
